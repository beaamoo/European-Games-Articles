...
# Set up your OpenAI API credentials
    ...
    # Input text
    input_text = f'''Compose a blog article for the European games 2023 in Krakow summarizing today's medal awards across different sports and divisions, while bearing in mind today's date: {date}. 
                    ...
                    Avoid using labels like 'Introduction' or 'Conclusion'. Keep the introduction under 150 words, the main body within 600 words, and the conclusion under 150 words. Use a storytelling approach, devoid of excessive expressive words like incredible, amazing, thrilling, outstanding, remarkable skill, or prowess, to present the athletes' achievements. {info}'''

    # Prompt
    prompt = f'''{event_df_section} 
                {ranking_df_section} 
                {schedule_section} 
                Generate an article that will not have too many expressive words. do not say: incredible, amazing, thrilling,outstanding, remarkable skill, prowess. I do not want such expressiveness. You must be journalistic professional. This is the most important point: 
                {input_text}'''
